...
from .models import Profile, MonoPage, MonoPost, MonoComment, FriendRequest, UserIntPage, UserIntPost, UserIntComment, UserIntUser, PageAttribute, UserIntAttribute, FollowingPage, AffiliateLinks, UserRecommendedPage, UserRecommendedUser
...
class MonoPageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'title', "summary", "rating", 'created_on',
                  'img', 'followed', 'attribute', 'affiliateId', 'goodpoint', 'badpoint')
        extra_kwargs = {'userCreate': {'read_only': True}}
